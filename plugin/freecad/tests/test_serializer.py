from plugin.freecad.serializer import serialize_document, Control


class BB:
    def __init__(self, x, y, z):
        self.XLength = x; self.YLength = y; self.ZLength = z
...
def test_serialize_document_with_controls_and_bbox():
    objs = [
        Obj('CTRL_BUTTON_1', shape=Shape(BB(100, 50, 30)), placement=Placement(1,2,3)),
